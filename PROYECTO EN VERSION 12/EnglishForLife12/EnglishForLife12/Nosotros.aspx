<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="Nosotros.aspx.cs" Inherits="EnglishForLife12.Nosotros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="caja">
        <h2>MISIÓN</h2>
        <p>Somos una empresa que nos disponemos al mejoramiento de la educación a través de  innovación y 
