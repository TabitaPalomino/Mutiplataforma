<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="ConfirmarOCAlum.aspx.cs" Inherits="EnglishForLife12.ConfirmarOCAlum" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="Lcaja" style="background-image:url('img/fondoOLVIDE.png');">
            ...
            <div class="Lcaja-login" style="width:35%; margin-top:140px;">
                ...
                <br />
                <asp:Button class="Buttonenviar" runat="server" Text="Aceptar" style="width:30%; margin-left:32%; background-color:#f82e2e;" OnClick="Unnamed1_Click"/>
            </div>
    </div>
</asp:Content>
