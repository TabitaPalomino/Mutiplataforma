...
>>>>>>> 69ba0d20db74a267c9afb01e493cbf41c896dbd4
            ...
            <div  class="CostroREnta">
                <div class="cajaPrecio">
                    <h4 class="TiTlePre" >Precio Total</h4>
                    <div class="cuentaPagar"><h5 class="PrecioNUme">S/. 210</h5></div>
                    <input class="CodexGig" type="text" name="form-username" placeholder="Codigo de Descuento" >
                    <asp:Button class="AceptarPreci" runat="server" Text="Aceptar" OnClick="Unnamed_Click" />
                </div>
                <div class="PreciosCostos">
                    <h4 class="TiTlePre" >Lista de Precios</h4>
                    <h5 >Profesor:         S/.  60</h5>
                    <h5>Precio por Hora:  S/.  30</h5>
                    <h5>Nivel 1:          S/.  40</h5>
                    <h5>Nivel 2:          S/.  45</h5>
                    <h5>Nivel 3:          S/.  50</h5>
                    <h5>Nivel 4:          S/.  60</h5>
